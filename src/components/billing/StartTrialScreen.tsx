  ...
  return (
    <OnboardingShell>
      ...
      <p className="mt-3 font-body text-sm leading-relaxed text-silver">
        Plan fasting days ahead, customize your weekly rhythm, and track your progress over time. Card or
        PayPal required to start — cancel anytime before the trial ends and you won&apos;t be charged.
      </p>
